...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'client/bower_components/angular-toggle-switch/angular-toggle-switch.js',
      ...
      'client/bower_components/morrisjs/morris.js',
      'client/bower_components/datatables-responsive/js/dataTables.responsive.js',
      'client/bower_components/flot.tooltip/js/jquery.flot.tooltip.js',
      'client/bower_components/startbootstrap-sb-admin-2/dist/js/sb-admin-2.js',
